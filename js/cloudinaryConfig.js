...
async function uploadImageToCloudinary(file) {
    ...
    const cloudName = "dgnbu754q";       // Thay bằng cloud_name của bạn trên Cloudinary
    const uploadPreset = "hoarestaurant";      // Thay bằng upload_preset đã tạo trong Cloudinary
